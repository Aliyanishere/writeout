        ...
        <div class="main_create">
          ...
          >
            ...
            style="margin-top: 120px">
              <img class="mt-0 mt-lg-5 " src="~/assets/images/tick.png" alt="" />
              <p class="fs-5 mb-0 mt-2">Story Line Submitted</p>
              <p class="fw-300">The audience will vote. Good luck!</p>
            </div>

            <div class="setup mb-2 mb-lg-0">
              <button
                class="login2 mb-2 mb-lg-0 mt-2"
