              ...
              <div class="invitation_tabs mb-5 mb-lg-0">
                <div class="round_tab">
                  <div class="d-flex justify-content-start align-items-start">
                    ...
                    >
                      <p class="mb-0 mx-2">GIRL</p>
                      <p class="mx-2 text-muted">
                        I fluffing hate a guy named kyler
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="round_tab">
                  <div class="d-flex justify-content-start align-items-start">
                    <div
                      ...
                      style="overflow: hidden"
                    >
                      <p class="mb-0 mx-2">THERAPIST</p>
                      <p class="mx-2 mb-0 text-muted">
                        Tyler needs some help it’s ok hes got me to help.
                      </p>
                    </div>
                  </div>
                </div>

                <div class="round_tab3">
                  <div class="d-flex justify-content-start align-items-start">
                    <div
                      class="d-flex justify-content-start align-items-start flex-column"
                      style="overflow: hidden"
