    ...
    <div class="bg2">
      <div class="container" style="margin-top: 150px">
        ...
        <div class="main_create">
          ...
          >
            <div class="game_will_start_in mt-0 mb-5">
              <p class="fs-4">The Dunkin Disaster</p>
            </div>

            <div
              class="mt-5 mb-2 d-flex justify-content-center align-items-center flex-column"
            >
              <p class="mb-0 mt-5">
                Tylor <span class="text-muted">won the game!</span>
              </p>
              <p class="mb-0 text-success">+250 coins</p>
            </div>

            <div
              class="mt-5 d-flex justify-content-center align-items-center flex-column"
            >
              <p class="mb-0 mt-5">The Dunkin Disaster</p>
              <p class="text-muted">
            ...
            <button
              class="mb-0 share2 mt-5"
              style="display: flex; justify-content: center"
            >
              Share
            </button>
            <div class="setup mb-2">
              <button
                class="login2 mb-2 mt-2"
                style="display: flex; justify-content: center"
              >
                Close
              </button>
