        ...
        <div class="main_create">
          ...
          <div class="create_content">
            ...
            <div class="game_will_start_in">
              <div class="round1">
                <p class="text-danger mb-0">Final Round</p>
              </div>
              <p class="fs-4 mb-2">00:59s</p>
              <p>Taylor <span class="text-muted">vs</span> Ella</p>
            </div>
            ...
            <div class="mt-4">
              ...
              >
                ...
                <div class="lines_tab">
                  <div class="d-flex justify-content-start align-items-start">
                    <div
                      ...
                      style="overflow: hidden"
                    >
                      <p class="mb-0 mx-2">DELORIS</p>
                      <p class="mx-2 mb-0 text-muted" style="font-size: 15px">
                        He wants his bagel bites
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="ms-2 d-flex">
                  <div class="roadmap">
                    <img src="~assets/images/roadmap3.png" alt="" />
                  </div>
                  <div class="mb-5">
                    <p class="text-center mt-3">Choose your next line</p>
                    <div class="lines_tab ms-2 selected_line">
                      <div
                        class="
                          w-100
                          d-flex
