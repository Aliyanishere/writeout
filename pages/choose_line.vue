<template>
  <div>
    <div class="container mob_nav">
      <i class="fas fa-arrow-left fs-4" style="color: #f05342"></i>
      <img width="100px" src="~/assets/images/logo.png" alt="" />
      <i class="fas fa-comments fs-1" style="color: #f05342"></i>
    </div>
        ...
        >
          <p
            class="
              text-white
              mb-2 mb-md-2
              mt-3 mt-md-3 mt-lg-0
              mb-lg-4
              me-0 me-md-0 me-lg-3
            "
          >
            @Koala23
          </p>
        ...
        <div class="main_create">
          ...
          <div class="create_content">
            <div class="switches">
              ...
              <button class="writers_switch2">Chat</button>
            </div>

            <div class="game_will_start_in justify-content-center align-items-center w-50">
              <div class="round1">
                <p class="text-danger mb-0">Round 1</p>
              </div>
              <p class="fs-4">00:12s</p>
            </div>
              ...
              <div class="invitation_tabs mb-5 mb-lg-0">
                <div class="lines_tab">
                  <div class="d-flex justify-content-start align-items-start">
                    ...
                    >
                      <p class="mb-0 mx-2">JAY</p>
                      <p class="mx-2 mb-0 text-muted" style="font-size: 15px">
                        Tyler, what the heck do you want today?
                      </p>
                    </div>
                  </div>
                </div>
                <div class="ms-2 d-flex">
                  ...
                  <div class="mb-5">
                    <p class="mt-3 mb-2 text-center">Choose the next line</p>
                    <div class="lines_tab ms-2 line_active tab_num_1" id="line_tabs" v-on:click="tab('tab_num_1')">
                      <div
                        class="
                          w-100
                          d-flex
                      ...
                      >
                        <div
                          class="
                            ...
                            flex-column
                          "
                           v-on:click="tab('tab_num_1')"
                        >
                          <p class="mb-0 mx-2">TYLER</p>
                          <p class="mx-2 mb-0" style="font-size: 15px">
                            I want the usual
                          </p>
                        </div>
                    ...
                    <div class="lines_tab mt-3 ms-2 tab_num_2" id="line_tabs" v-on:click="tab('tab_num_2')">
                      <div
                        class="
                          w-100
                          d-flex
                      ...
                      >
                        <div
                          ...
                          style="overflow: hidden"
                        >
                          <p class="mb-0 mx-2">TAYLOR</p>
                          <p
                            class="mx-2 mb-0"
                            style="font-size: 15px"
                          >
                            Hey bestie, how’s doggo?
                          </p>
                        </div>
                      </div>
                        <i class="fas fa-check-circle" id="check"></i>
                    ...
                    <div class="lines_tab mt-2 ms-2 tab_num_3" id="line_tabs" v-on:click="tab('tab_num_3')">
                      <div
                        class="
                          w-100
                          d-flex
                    ...
                    <div class="lines_tab mt-2 ms-2 tab_num_4" id="line_tabs" v-on:click="tab('tab_num_4')">
                      <div
                        class="
                          w-100
                          d-flex
                      ...
                      >
                        ...
                        >
                          ...
                          <p
                            ...
                            style="font-size: 15px"
                          >
                            She knows what I want. She wants it too.
                          </p>
                        </div>
                      </div>
                      <i class="fas fa-check-circle" id="check"></i>
                    ...
                    <div class="lines_tab mt-2 ms-2 tab_num_5" id="line_tabs" v-on:click="tab('tab_num_5')">
                      <div
                        class="
                          w-100
                          d-flex
...
export default {
  methods: {
    tab(ele) {
      document.querySelectorAll('.lines_tab').forEach(element => {
        element.classList.remove("line_active");
      });
     document.querySelector("."+ele).classList.add("line_active");
