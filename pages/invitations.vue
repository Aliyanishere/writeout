<template>
  <div>
    <div class="container mob_nav">
      ...
      <img width="100px" src="~/assets/images/logo.png" alt="" style="margin-left: -20px" />
    ...
    <div class="bg2">
      <div class="container" style="margin-top: 150px">
        <div class="mb-2 mb-lg-5 create_game mt-2 mt-lg-5 mt-lg-0">
          ...
          <p class="mb-1 fs-5">Send Invitations</p>
        </div>
          ...
          <div class="create_content">
            <div class="invitation_inputs">
              ...
              <button class="login2 setup">
                Send Invite <i class="fas fa-check text-white"></i>
              </button>
            </div>

            <div class="mt-4">
              <p class="mb-0 ms-3">Writers 4/4</p>
              <div class="invitation_tabs">
                ...
                <div class="invitaion_tab">
                  <div class="d-flex justify-content-start align-items-start">
                    ...
                    <div
                      class="d-flex justify-content-start align-items-center flex-column"
                    >
                      <p class="mb-0" style="margin-left: -20px">Emma Parker</p>
                      <p class="mb-0 ms-3 text-muted">Last online 2h ago</p>
                    </div>
                  </div>
