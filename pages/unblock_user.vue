    ...
    <div class="bg2">
      <div class="container" style="margin-top: 150px">
        <div class="mb-2 mb-lg-5 create_game2 mt-2 mt-lg-5 mt-lg-0">
          ...
          <p class="mb-1 fs-5">Koala23’s Profile</p>
        </div>
        ...
        <div class="main_create">
          ...
          <div
            class="create_content2 story_submit"
          ...
          >
            ...
            >
              ...
              >
                ...
                <p class="mb-0 mt-5 mt-lg-2" style="font-weight: 200; font-size: 15px">
                  You cannot interact with a blocked user
                </p>
              </div>
            </div>
